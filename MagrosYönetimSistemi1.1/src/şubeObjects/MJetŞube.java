...
public class MJetŞube extends Şube implements Serializable{

	private static final long serialVersionUID = 1L;
	private String storeTürü;
	private static int mevcutŞubeSayısı = 0;

	public MJetŞube(String postaKodu, String açıkAdres, String ilçe) {
		super(postaKodu, açıkAdres, ilçe);
		storeName = createStoreName();
		storeTürü = "Migros Jet";
